				...
				<div className="py-12 md:py-20">
					...
					<div className="max-w-3xl pb-12 mx-auto text-center md:pb-16">
						<h2 className="mb-4 h2">
							Backed by over 20,000 donors. Operated by 5000+ local partners
						</h2>
						<p className="text-xl text-gray-600" data-aos="zoom-y-out">
							...
							implementing effective, sustainable water projects in their area.
						</p>
						<br />
						<p className="text-xl text-gray-600" data-aos="zoom-y-out">
							This has been made possible only because of our well-wishers and
							donors, who have helped in raising funds to pay the partners and
							buy equipment.
						</p>
					</div>
							...
							<div className="px-12 py-8 pt-20 mx-4 text-center md:mx-0">
								<div className="absolute top-0 -mt-8 transform -translate-x-1/2 left-1/2">
									<img
										...
										src={require('../images/testimonial.jpg').default}
										width="96"
										height="96"
										alt="Testimonial 01"
									/>
								...
								<blockquote className="mb-4 text-xl font-medium">
									“ I've seen the effect of dirty water first hand in my native
									country of Haiti. When I came to America, I wanted to
									proactively support a mission that focused on solving the
									water problem, and the Charity Water Project has been doing
									exactly that “
								</blockquote>
