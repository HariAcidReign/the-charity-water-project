					...
					<div className="pb-12 text-center md:pb-16">
						...
						<div className="max-w-3xl mx-auto">
							<p
								...
								data-aos="zoom-y-out"
								data-aos-delay="150">
								The water crisis is massive. But together, we can solve it. Join
								The Charity Water Project to bring clean and safe water to
								families around the world every single month.
							</p>
							<div
						...
						<Modal
							...
							<div className="relative pb-9/16">
								<iframe
									...
									src="https://player.vimeo.com/video/140235935"
									title="Video"
