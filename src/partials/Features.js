				...
				<div className="pt-12 md:pt-20">
					...
					<div className="max-w-3xl pb-12 mx-auto text-center md:pb-16">
						<h1 className="mb-4 h2">
							785 million people lack basic access to safe drinking water.
						</h1>
							...
							<div className="mb-8 md:mb-0">
								<a
									...
									<div>
										...
										<div className="text-gray-600">
											Access to clean water changes life for women and girls
											around the world.
										</div>
								...
								<a
									...
									<div>
										...
										<div className="text-gray-600">
											Meet Hadjara, a brave 12-year-old girl who refused to eat
											until her whole family started washing their hands.
										</div>
										<a className="text-sm text-blue-600 hover:underline">
											Read more
										</a>
								...
								<a
									...
									<div>
										<div className="mb-1 font-bold leading-snug tracking-tight">
											What Helen Taught Us
										</div>
										<div className="text-gray-600">
											Meet Helen, who talked about clean water in a way we’d
											never heard before.
										</div>
										<a className="text-sm text-blue-600 hover:underline">
											Read more
							...
							<div className="relative flex flex-col text-center lg:text-right">
								...
								<Transition
									...
									<div className="relative inline-flex flex-col">
										<img
											...
											src={require('../images/tab-one.png').default}
											width="500"
											height="462"
											alt="Features bg"
										/>
								...
								<Transition
									...
									<div className="relative inline-flex flex-col">
										<img
											className="mx-auto rounded md:max-w-none"
											src={require('../images/tab-two.png').default}
											width="500"
											height="462"
											alt="Features bg"
										/>
								...
								<Transition
									...
									<div className="relative inline-flex flex-col">
										<img
											className="mx-auto rounded md:max-w-none"
											src={require('../images/tab-three.png').default}
											width="500"
											height="462"
											alt="Features bg"
										/>
